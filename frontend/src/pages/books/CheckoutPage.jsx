                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                ...
                                                type="text" name="country" id="country" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Country" />
                                        </div>
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                ...
                                                type="text" name="state" id="state" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="State" />
                                        </div>
                                        ...
                                        <div className="md:col-span-1">
                                            ...
                                            <input
                                                ...
                                                type="text" name="zipcode" id="zipcode" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" />
                                        </div>
